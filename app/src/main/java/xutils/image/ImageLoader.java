...
/*package*/ final class ImageLoader implements
    ...
    static Cancelable doLoadFile(final String url,
        ...
        params = createRequestParams(url, options);
        ...
        if (memDrawable != null) { // has mem cache
            ...
            try {
                ...
                if (callback instanceof CacheCallback) {
                    trustMemCache = ((CacheCallback<Drawable>) callback).onCache(params, memDrawable);
                    if (!trustMemCache) {
                        // not trust the cache
                    ...
                    callback.onSuccess(params, memDrawable);
                }
            } catch (Throwable ex) {
    ...
    @Override
    public boolean onCache( RequestParams params, Drawable result) {
        ...
        if (result != null) {
            ...
            if (cacheCallback != null) {
                return cacheCallback.onCache(params,result);
            } else if (callback != null) {
                callback.onSuccess(params,result);
                return true;
            }
            return true;
        }
    ...
    @Override
    public void onSuccess(RequestParams params,Drawable result) {

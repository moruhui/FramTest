...
public class AutoTableLayout extends TableLayout {
    ...
    public AutoTableLayout.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new AutoTableLayout.LayoutParams(this.getContext(), attrs);
    }

    public static class LayoutParams extends android.widget.TableLayout.LayoutParams implements AutoLayoutHelper.AutoLayoutParams {
